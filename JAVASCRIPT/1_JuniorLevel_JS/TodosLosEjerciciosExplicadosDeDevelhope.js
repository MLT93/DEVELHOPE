...
var y = 4
var y = "Pedrito" // No modifica nada, simplemente es otra variable más
...
let hello = 'ciao';     // boolean -> true o false
let age = "21";       // string -> comillas
let isGraduated = 0965;     // number -> 29038
...
1 name == lastname
2 age <= average
3 firstYearCompleted == lastname
4 yearsCompleted == firstYearCompleted
5 firstYearCompleted === yearsCompleted
6 examsCompleted < age
7 isGraduated > yearsCompleted
...
console.log("Primera comparación || con la 1º variable y la 2ª variable =" + "", question1 || question2) //the result must be true ♦ Con || si las dos condiciones son true, dará TRUE. Si la primera es true y la segunda es false, dará TRUE. Si la primera es false y la segunda es false, será FALSE. Si la primera es false y la segunda es true, será TRUE.
console.log("Segunda comparación && con la 1º variable y la 2ª variable =" + "", question1 && question2) //the result must be false ♦ Con && si las dos condiciones son true, dará TRUE. Si la primera es true y la segunda es false, dará FALSE. Si la primera es false y la segunda es false, será FALSE. Si la primera es false y la segunda es ture, será FALSE.
...
console.log(age >= 18 ? "you can drive a car" : "NO PUEDES")
...
// Lau
let age = 17;
console.log(age >= 18 ? "Puedes conducir un coche" : "No puedes conducir un coche");
...
isSunnyDay==true? console.log("jesse can go out to play"): console.log("Jesse stays home");
...
let numberMessage = number > 0 ? "The number is positive" : "The number is negative";
// Imprimo en consola.
...
if(password.legth < 4 || password.length > 6) {
    console.log("The password is not valid");
} else console.log("the password is correct")


// Lau
const password = 'Hi560';

console.log(password.length > 4 && password.length < 6 ? "Password length is correct" : "Pasword not valid");

if(password.length > 4 && password.length < 6){
    console.log("Password length is correct");
} else console.log("Pasword not valid");
...
switch (typeof primitive) {
  ...
  case "boolean":
    ...
    break;
  default:
    console.log("Esta tipo de variable no esta estudiada todavia");
}
...
switch (priceRoom[0]) {
    case 50: { // Los "case" acceden al valor que tengo guardado dentro de una variable, siempre que sea <String> o <Number>. Por lo tanto, deberé seleccionar directamente el dato que deseo analizar, en este caso equivale a 50, que corresponde al valor de la variable precioBasicoDeEneroAMayo.
...
comprobarParImpar2(); // NO me hace falta asignar ningún parámetro entre los paréntesis porque mi función no tiene parámetros. Para darle los valores a ejecutar, cambiaré la variable externa que utilizo déntro de mi
