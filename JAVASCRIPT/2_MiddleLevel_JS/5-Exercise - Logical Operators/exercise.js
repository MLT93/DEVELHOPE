...
console.log(question1 || question2);  // the result must be true  (false / true)
console.log(question1 && question2);  // the result must be false (false / true)
console.log(question3 || question2);  // the result must be true  (false true)
console.log(question4 !== question4); // the result must be false (true / true)
console.log(question2 && !question4); // the result must be false (true / !false)
