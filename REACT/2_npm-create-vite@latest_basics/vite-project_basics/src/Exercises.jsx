...
export const AlertClock = ({ handleClick }) => {
  return (
    <div style={{ padding: "20px" }}>
      <p>
...
export const Counter = ({ initialValue, incrementAmount, decrementAmount }) => {
...
export const Colors = ({ id, name, color }) => {
...
export const ArrayComponent = ({ array }) => {
  return (
    <div style={{ padding: "20px" }}>
      <ul>
        {array &&
...
export const MyCard = ({ username, id, name, lastName, avatar }) => {
  return (
    <div style={{ padding: "20px" }}>
      <div
        style={{
...
export const MyToDoComponent = ({ arr }) => {
