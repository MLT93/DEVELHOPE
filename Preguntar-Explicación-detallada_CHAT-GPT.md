Realiza una explicación igual a la que te expongo a continuación, con la misma cantidad de detalles y explicando `Test the HTTP server: Una Explicación Detallada` de la misma forma:
